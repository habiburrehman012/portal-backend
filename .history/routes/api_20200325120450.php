...
Route::post('/products/add',function(Request $request){
    ...
    {
        report($e);
        return response()->json(["success"=>false,"status"=>500,"message"=>"An error occured while adding product"]);
    }
});
...
Route::get('/products/get-all',function(){
    ...
    {
        report($e);
        return response()->json(["success"=>false,"status"=>500,"data"=>"An error occured while adding product"]);
    }
});